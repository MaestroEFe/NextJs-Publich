      ...
      <div className="flex flex-1 overflow-hidden bg-gray-100 dark:bg-gray-900">
        <aside className="w-64 bg-white dark:bg-gray-800 shadow-md overflow-y-auto">
          ...
          <nav className="mt-6">
            ...
            <h3 className="px-6 py-2 text-xs font-semibold text-gray-500 uppercase">Submissions</h3>
            <a href="/admin/inquiries" className="block px-6 py-2.5 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700">Service Inquiries</a>
            <a href="/admin/contacts" className="block px-6 py-2.5 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700">Contact Messages</a>
          </nav>
        </aside>
